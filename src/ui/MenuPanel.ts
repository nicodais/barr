 ...
 *
 * Deliberately not a full menu. It holds the three levers that change what you
 * are looking at, and leaves the settings that get set once (steering, quality,
 * audio) in the options panel where they belong.
 */
...
export class MenuPanel {
  ...
  constructor(private cb: MenuCallbacks) {
    ...
    this.element.append(this.regionRow.parentElement!, this.bodyRow.parentElement!, this.timeRow.parentElement!);
  }
