...
// at, elev, azim, sunCol, sunI, zenith, horizon, hemiSky, hemiGround, hemiI, fog, near, far
//
...
// turns monochrome peach and the dunes stop reading against it.
const KEYFRAMES: Keyframe[] = [
  // Blue hour, pre-dawn. Deep navy, sun still below the horizon.
  key(0.00, -4, 70, 0x5a6d9e, 0.25, 0x111a3c, 0x53506e, 0x3d4c86, 0x2e2b3f, 0.85, 0x54506c, 90, 620),
  // Sunrise: the sun cracks the horizon and everything goes amber.
  key(0.10, 4, 78, 0xffab5e, 2.10, 0x1e3f80, 0xe0925c, 0x6f89c4, 0x8a6440, 1.00, 0xd68f60, 130, 800),
  // Morning gold — a wide, generous band.
  key(0.24, 20, 95, 0xffd39a, 2.70, 0x2f6ec4, 0xe8b98a, 0x89a6d6, 0xb08355, 1.05, 0xe3b184, 180, 950),
  // Midday. Kept short and never fully neutral; this is the least interesting light.
  key(0.42, 62, 150, 0xfff3dd, 3.00, 0x3f92e2, 0xd8cbb2, 0x9dbde2, 0xbf9a6e, 1.10, 0xd6c8ae, 240, 1100),
  // Afternoon, sliding back toward warmth.
  key(0.60, 30, 225, 0xffd9a4, 2.75, 0x3574c6, 0xe3b48b, 0x8caad8, 0xb4855a, 1.05, 0xdfae86, 190, 980),
  // The hero light. Long shadows, saturated sand, indigo in the lee faces.
  key(0.76, 9, 250, 0xffb26b, 2.45, 0x2455a8, 0xeaa367, 0x7593cc, 0x9c6e44, 0.95, 0xe09a64, 140, 850),
  // Sunset proper.
  key(0.87, 1, 262, 0xff8c4a, 1.70, 0x18367c, 0xdd7d52, 0x5f78b6, 0x7a5238, 0.90, 0xcf7d55, 110, 720),
  // Blue hour, dusk — mirrors the opening so the loop is seamless.
  key(0.95, -5, 270, 0x6274a6, 0.30, 0x13204a, 0x585d7a, 0x42518c, 0x312e43, 0.85, 0x585472, 90, 640),
];
