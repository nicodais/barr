...
// at, elev, azim, sunCol, sunI, zenith, horizon, hemiSky, hemiGround, hemiI, fog, near, far, haze, hazeCol
//
...
const KEYFRAMES: Keyframe[] = [
  ...
  key(0.00, -4, 70, 0x5a6d9e, 0.25, 0x111a3c, 0x53506e, 0x3d4c86, 0x2e2b3f, 0.85, 0x54506c, 90, 620, 0.10, 0x6b6d84),
  ...
  key(0.87, 1, 262, 0xff8c4a, 1.70, 0x18367c, 0xdd7d52, 0x5f78b6, 0x7a5238, 0.90, 0xcf7d55, 110, 690, 0.34, 0xc98f68),
  // Blue hour, dusk — mirrors the opening so the loop is seamless.
  key(0.95, -5, 270, 0x6274a6, 0.30, 0x13204a, 0x585d7a, 0x42518c, 0x312e43, 0.85, 0x585472, 90, 640, 0.18, 0x70718a),
];
